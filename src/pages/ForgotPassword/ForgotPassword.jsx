			...
			<div className={classes.forgot__home__container}>
				<div className={classes.forgot__container}>
						...
						<div className={classes.forgot__card}>
							{isVisible ? (
								<div>
									...
									<form onSubmit={handleSubmit}>
										<div class="container">
											...
											<div>
												<button type="submit" className={classes.forgotbtn}>
													Submit Email
												</button>
											</div>
										</div>
								...
								<div className={classes.forgot__submitted}>
									<p className={classes.forgot__submitted__title}>
					...
					<div className={classes.forgot__info__container}>
						...
						<p className={classes.forgot__info}>
						...
						<button
							className={classes.forgot__new__account}
